    ...
    return(
        <section className="course-types">
            <div className="edcourse-intro">
                ...
                <img src="https://satyanarayanaakula26.github.io/edualtech_frontend/assets/educationimg.jpg" alt="education" />
        ...
        <div className="nonedcourse-intro">
                ...
                <img src="https://satyanarayanaakula26.github.io/edualtech_frontend/assets/art.jpg" alt="passion" className="gallery-img img1" />
                <img src="https://satyanarayanaakula26.github.io/edualtech_frontend/assets/music.jpg" alt="passion" className="gallery-img img2"/>
                <img src="https://satyanarayanaakula26.github.io/edualtech_frontend/assets/sports-tools.jpg" alt="passion" className="gallery-img img3"/>
                </div>
